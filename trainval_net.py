...
# CUDA_VISIBLE_DEVICES=0 python trainval_net.py --bs 4 --nw 1 --use_tfb --cuda --r RESUME
# --------------------------------------------------------
...
if __name__ == '__main__':
    ...
    if args.dataset == "pascal_voc":
        ...
        args.imdb_name = "AG-train"
        args.imdbval_name = "AG-test"
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]',
                         'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
    ...
    args.cuda = True # Use GPU by design
    ...
    if args.net == 'vgg16':
        ...
        fasterRCNN = resnet(imdb.classes, 101, pretrained=False, # True
                            class_agnostic=args.class_agnostic)
    elif args.net == 'res50':
