...
CUDA_VISIBLE_DEVICES=1 python trainval_net.py \
                   --dataset ag --net res101 \
                   --bs 4 --nw 4 \
                   --lr 0.001 --lr_decay_step 4 \
                   --cuda
```
...
```
--r True --checksession 1 --checkepoch 2 --checkpoint 124148
```

## Test Action Genome:
```
CUDA_VISIBLE_DEVICES=1 python test_net.py --dataset ag --net res101 \
                   --checksession 1 --checkepoch 2 --checkpoint 124148 \
                   --cuda
```