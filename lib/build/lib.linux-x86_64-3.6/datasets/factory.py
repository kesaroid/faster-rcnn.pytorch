...
from datasets.ag import AGDataset
...
# set up action genome.
for split in ['train', 'test', 'trainval']:
    name = 'action_genome_relationship_{}_v1'.format(split)
    data_path = name
    __sets[name] = (lambda split=split, data_path=data_path: AGDataset(split, data_path))    
